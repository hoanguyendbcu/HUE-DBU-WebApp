...
namespace DBCU_WebApp.core
{
    public static class Utils
    {
        ...
        public static string IsActiveNav(this IHtmlHelper html, string controller = null, string action = null, string cssClass = null)
        {
            ...
            return controller.ToLower().Split(',').Contains(currentController.ToLower()) ?
                cssClass : String.Empty;
        }
    }
}